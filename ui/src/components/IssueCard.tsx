...
const severityConfig: Record<MessageSeverity, { bg: string; border: string; icon: string; text: string }> = {
  critical: { bg: 'bg-red-900/40', border: 'border-red-600', icon: 'text-red-400', text: 'text-red-300' },
  error: { bg: 'bg-red-900/30', border: 'border-red-700', icon: 'text-red-400', text: 'text-red-300' },
  warning: { bg: 'bg-yellow-900/30', border: 'border-yellow-700', icon: 'text-yellow-400', text: 'text-yellow-300' },
  info: { bg: 'bg-blue-900/30', border: 'border-blue-700', icon: 'text-blue-400', text: 'text-blue-300' },
  debug: { bg: 'bg-slate-800', border: 'border-slate-600', icon: 'text-slate-400', text: 'text-slate-300' },
};
